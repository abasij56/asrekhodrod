	...
	private static function cdn_fields( array $defaults ): array {
		return array(
			...
			array(
				...
				'name'         => 'cdn_host',
				'type'         => 'text',
				'placeholder'  => 'media.asrekhodro.com',
			),
			array(
			...
			array(
				...
				'placeholder'   => '/AsreKhodro',
				'instructions'  => __( 'مسیر FTP که بعد از ورود به آن می‌چرخید. مثال: /AsreKhodro یا /AsreKhodro/Uploaded — اگر Uploaded را اینجا گذاشتید، در مسیر آپلود دوباره تکرار نمی‌شود.', 'asrekhodro' ),
			),
			array(
